...
public class ArrayDequeTest {
    public static void main(String[] args) {
         ...
         * Note.md.md.md.md: offer(), offerFirst() and offerLast() returns true if the element is successfully inserted; if the array deque is full, these methods return false.
         */
         ...
         * Note.md.md.md.md: If the array deque is empty, getFirst() and getLast() throws NoSuchElementException.
         */
