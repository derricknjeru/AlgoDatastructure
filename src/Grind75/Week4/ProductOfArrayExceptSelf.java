...
public class ProductOfArrayExceptSelf {
    ...
    static class Solution {
         ...
         * and uses O(1) extra space for the prefix and suffix product arrays.
         *
         * @param nums
         * @return
         */
    ...
    class Solution2 {
        /**
         * This algorithm runs in O(n) time complexity
         * and uses O(n) extra space for the prefix and suffix product arrays.
         *
         * @param nums
         * @return
         */
    ...
    public static void main(String[] args) {
        ...
        int[] result1 = sln.productExceptSelf(nums1);
        System.out.println("Input: [1, 2, 3, 4]");
        System.out.print("Output: "); //[24,12,8,6]
        for (int num : result1) {
        ...
        int[] nums2 = {-1, 1, 0, -3, 3};
        int[] result2 = sln.productExceptSelf(nums2);
        System.out.println("Input: [-1, 1, 0, -3, 3]");
        System.out.print("Output: "); //[0,0,9,0,0]
        for (int num : result2) {
            System.out.print(num + " ");
        }
        System.out.println();
