...
public class FindMotherVertex {
    public static void main(String[] args) {
        ...
        //1. Undirected connected graph ---> All the vertices are mother vertices
        //as we can reach to all the other nodes in the graph.
        //2. Undirected/Directed disconnected graph ---> In this case, there is no mother vertices
        //as we can not reach all the other nodes in the graph
        //3. Directed connected graph , In this case, we have to find a vertex -v such that we can reach
        //to all the other nodes in the graph through a directed graph.

        /**
         * This solution is based on Kosaraju’s Strongly Connected Component Algorithm.
         * Initially, we run the DFS on the whole graph in a loop (line 13).
