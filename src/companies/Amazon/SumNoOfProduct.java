 ...
 * <p>
 * Note.md.md that we are forced to pick only 3 products from index 1 as the maximum number of products we can pick from index 2 is 4 and we need to make sure it is greater than the number of products picked from index 1.
 * <p>
 ...
 * <p>
 * These are some ways strictly increasing subarrays can be chosen (1-based index): 2 • Choose subarray from indices (1, 3) and pick products [3, 4, 5) respectively from each index, which is 12 products. Note.md.md that we are forced to pick only 3 products from index 1 as the maximum number of products we can pick from index 2 is 4 and we need to make sure it is greater than the number of products picked from index 1.
 * <p>
