package CodingInterviewPatterns.stack_and_queue.quickreview.MonotonicStack;
...
public class DailyTemperatures {
     ...
     * <p>
     * Note.md.md.md.md: answer does not count towards the space complexity because space used for the output format does not count.
     **/
