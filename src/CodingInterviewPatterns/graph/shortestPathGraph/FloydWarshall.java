...
public class FloydWarshall {
    ...
    void floydWarshall(int[][] graph) {
        ...
        // Assign all values of CodingInterviewPatterns.graph to allPairs_SP
        for (int i = 0; i < V; ++i)
    ...
    public static void main(String[] args) {
        /**
         * int CodingInterviewPatterns.graph[][] = { { 0,   5,  INF, 10 },
         *                   { INF, 0,  3,  INF },
         *                   { INF, INF, 0,   1 },
         *                   { INF, INF, INF, 0 } };
         *
         * Above represents the following CodingInterviewPatterns.graph:
         *         10
         *    (0)----->(3)
         *     |        /|\
         *   5 |         | 1
         ...
         *
         *
         * The given illustration represents a directed CodingInterviewPatterns.graph with four vertices labeled 0, 1, 2, and 3. The numbers on the edges indicate the weights or distances between the connected vertices.
         *
         ...
         * Additionally, the symbol \|/ in the illustration represents the existence of multiple paths or routes between vertex 1 and vertex 3. In this CodingInterviewPatterns.graph, there are two distinct paths from vertex 1 to vertex 3:
         *
         ...
         *
         * The presence of \|/ indicates that there are multiple possible paths between vertex 1 and vertex 3 in the CodingInterviewPatterns.graph, providing different options for traversal.
         */
