...
public class DecodeString {
     ...
     * <p>
     * The encoding rule is: k[encoded_string], where the encoded_string inside the square brackets is being repeated exactly k times. Note.md.md that k is guaranteed to be a positive integer.
     * <p>
