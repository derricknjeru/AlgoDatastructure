...
public class IntersectionOfTwoLinkedLists {
     ...
     * Explanation: The intersected node's value is 8 (note.md that this must not be 0 if the two lists intersect).
     ...
     * Explanation: The intersected node's value is 2 (note.md that this must not be 0 if the two lists intersect).
