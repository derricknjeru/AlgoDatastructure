...
public class CountAsterisks {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.countAsterisks(s1));  // Output: 2

        // Example 2
        String s2 = "iamprogrammer";
        System.out.println(solution.countAsterisks(s2));  // Output: 0

        // Example 3
        String s3 = "yo|uar|e**|b|e***au|tifu|l";
        System.out.println(solution.countAsterisks(s3));  // Output: 5
